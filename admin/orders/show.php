...
?>
    <div class="container mt-5 mb-5 shadow-sm p-3 mb-5 bg-body rounded">
        <div class="row">
            <div class="h3 text-dark text-center">Chi tiết hóa đơn <a href="./index.php" class="btn btn-secondary">Back</a></div>
        </div>
        <div class="row">
            <div class="col-xl-6 col-md-6 col-sm-12">
                ...
                ?>  
                <div class="text-dark h5">Đơn hàng #<?=$ketQua['order_id']?></div>
