    ...
    <table class="table table-striped">
      <thead>
        <tr class="table-primary text-center">
          ...
          <th scope="col" style="background-color:#C7C8C9">Title</th>
          <th scope="col" style="background-color:#C7C8C9">Content</th>
          <th scope="col" style="background-color:#C7C8C9">Image</th>
