...
<div class="container-fluid mt-5 mb-5">
    <div class="row mb-2 text-center">
        <div class="h3 text-dark">Danh sách sản phẩm</div>
	</div>
    <?php 
	...
	<div class="row mb-2">
        ...
        <a href="./add.php" class="ms-5 btn btn-primary"
   style="background-color: #C7C8C9; color: black; border: none; padding: 10px 20px; text-decoration: none;"
            ...
            <div class="container mb-5">  
                    ...
                    <div class="col-12 mb-3">
						<table class="table">
							<thead class="table-primary">
								<tr>
									<th scope="col" style="background-color:#C7C8C9">Id</th>
									<th scope="col" style="background-color:#C7C8C9">Tên sản phẩm</th>
									<th scope="col" style="background-color:#C7C8C9">Giá</th>
									<th scope="col" style="background-color:#C7C8C9">Giá giảm</th>
									<th scope="col" style="background-color:#C7C8C9">Hàng tồn</th>
									<th scope="col" style="background-color:#C7C8C9">Thao tác</th>
								</tr>
							</thead>
							<tbody>
							<?php
                ...
                <div class="row">
                    ...
                    <nav class="mt-3">
                        ...
                        ?>
                            <li class="page-item">
                                <a href="<?php echo $rootPath?>/products/index.php?page=<?php echo ($currentPage - 1); ?>" class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark" data-remote="true"><i class="fa-solid fa-arrow-left"></i></a>
                            </li>
                        <?php
                            }
                        ?>
                        ...
                        ?>
                            <li class="page-item">
                                <a href="<?php echo $rootPath;?>/products/index.php?page=<?php echo ($currentPage + 1) ?>" class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark" data-remote="true"><i class="fa-solid fa-arrow-right"></i></a>
                            </li>
                        <?php
                            }
                        ?>
