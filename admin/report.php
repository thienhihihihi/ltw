...
<div class="container my-5">
	<div class="row">
        <div class="col text-center h2 text-dark mb-4">
            Thống kê tổng quan
        </div>
    </div>
	<div class="row">
        <div class="col-xl-3 col-md-6 col-sm-12">
            <div class="card" style="background-color:#C7C8C9; color:black;" >
                <div class="card-body">
                    <h5 class="card-title text-dark" style="font-size: 40px;"><b><?=$countOrder?></b></h5>
                    <p class="card-text text-dark" style="font-size: 20px;">Đơn hàng</p>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 col-sm-12">
            <div class="card"  style="background-color:#C7C8C9;">
                <div class="card-body">
                <h5 class="card-title text-dark" style="font-size: 40px;"><b><?=$countProduct?></b></h5>
                    <p class="card-text text-dark" style="font-size: 20px;">Sản phẩm</p>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 col-sm-12">
            <div class="card" style="background-color:#C7C8C9;">
                <div class="card-body">
                <h5 class="card-title text-dark" style="font-size: 40px;">
    <b><?= isset($revenue) && $revenue !== null && $revenue !== '' ? $revenue : '0' ?></b>
</h5>
                    <p class="card-text text-dark" style="font-size: 20px;">Doanh thu (VND)</p>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 col-sm-12">
            <div class="card" style="background-color:#C7C8C9;">
                <div class="card-body">
                <h5 class="card-title text-dark" style="font-size: 40px;"><b><?=$countCustomer?></b></h5>
                    <p class="card-text text-dark" style="font-size: 20px;">Khách hàng</p>
                </div>
            </div>
        </div>
	</div>
