    ...
    <table class="table table-striped">
      <thead>
        <tr class="table-primary text-center">
          ...
          <th scope="col" style="background-color:#C7C8C9">Username</th>
          <th scope="col" style="background-color:#C7C8C9">Email</th>
          <th scope="col" style="background-color:#C7C8C9">Phone</th>
          <th scope="col" style="background-color:#C7C8C9">Address</th>
          <th scope="col" style="background-color:#C7C8C9">Update Date</th>
