...
if (isset($_SESSION["cart"]) && !empty($_SESSION["cart"])) {
                            ...
                            <table class="table">
                                <thead>
                                    <tr class="table-primary" >
                                        <th scope="col" style="background-color:#C7C8C9;">Sản phẩm</th>
                                        <th scope="col" style="background-color:#C7C8C9;">Đơn giá</th>
                                        <th scope="col" style="background-color:#C7C8C9;">Số lượng</th>
                                        <th scope="col" style="background-color:#C7C8C9;">Thành tiền</th>
                                        <th scope="col" style="background-color:#C7C8C9;">Chức năng</th>
                                    </tr>
                                </thead>
                                <tbody>';
    ...
    $cart .=    '</tbody>
                        ...
                        <div class="col-xl-3 col-md-4 col-sm-12">
                            <div class="container shadow-sm p-3 mb-5 bg-body rounded">
                                ...
                                <div class="row">
                                    <a href="' . $rootPath . '/customer/check_out.php" class="btn btn-dark"><strong>Đặt hàng</strong></a>
    ...
    $headerCart .= '<i class="fas fa-shopping-cart me-1"></i>' . sizeof($_SESSION['cart']);
} else {
    ...
    $headerCart .= '<i class="fas fa-shopping-cart me-1"></i> 0';
}
