...
?>
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="h4 text-dark">Danh sách đơn hàng</div>
        </div>
        <div class="row">
            <table class="table">
                <thead class="table-primary" style="background-color:#C7C8C9;">
                    <tr>
                        <th scope="col" style="background-color:#C7C8C9">STT</th>
                        <th scope="col" style="background-color:#C7C8C9">#Mã đơn</th>
                        <th scope="col" style="background-color:#C7C8C9">Người nhận</th>
                        <th scope="col" style="background-color:#C7C8C9">Nơi giao</th>
                        <th scope="col" style="background-color:#C7C8C9">Tổng tiền</th>
                        <th scope="col" style="background-color:#C7C8C9">Trạng thái</th>
                        <th scope="col" style="background-color:#C7C8C9">Ngày đặt</th>
