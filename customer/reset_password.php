...
<div class="container-fluid bg-light p-xxl-5 p-md-3">
    <div class="col-lg-8 col-md-10 m-auto py-5 px-3" style="box-shadow: 0 10px 20px rgb(0 0 0 / 10%);">
        <h1 class="h1 text-center"><b><code style="color: black; font-family:Muli, sans-serif;">Đổi mật khẩu</code></b></h1>
        <?php
            if ($status != "") {
        ...
        <form class="mx-5" method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
            ...
            <button type="submit" class="btn btn-primary float-end" style="background-color: #C7C8C9; color: black; border: 0; transition: background-color 0.3s ease, color 0.3s ease;" 
    onmouseover="this.style.backgroundColor='#A0A1A2'; this.style.color='white';" 
    onmouseout="this.style.backgroundColor='#C7C8C9'; this.style.color='black';">Cập nhật</button>
        </form>
    </div>
</div>
