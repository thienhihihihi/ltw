...
<div class="container-fluid mt-5 mb-5">
    ...
    <b class="user-select-none nav-link" >Category</b>
                ...
                ?>
                <a href="<?php echo $rootPath?>/product.php?categoryId=<?php echo $row['category_id']?>" class=" <?php if ($categoryId == $i) echo 'bg-dark text-dark bg-opacity-25' ?> list-group-item list-group-item-action "><?php echo $row['category_name']?></a>
                <?php
                        $i++;
                    }
                ?>  
                <a href="<?php echo $rootPath?>/product.php?categoryId=0" class="list-group-item list-group-item-action <?php if($categoryId == 0) echo 'bg-dark text-dark bg-opacity-25'?>">All</a>
            </div>
        </div>
    ...
    Detail
                            ...
                            <button onclick="addCartItem(<?=$row['product_id']?>)" 
    ...
    <i class="fa-light fa-cart-plus" style="color: black;"></i>
</button>
                        </div>
                        </div>
                    </div>
                ...
                <div class="row paging">
                    ...
                    <nav class="mt-3">
                        ...
                        ?>
                            <li class="page-item">
                                <a href="<?php echo $rootPath?>/product.php?categoryId=<?php echo $categoryId ?>&page=<?php echo ($currentPage - 1); ?>" class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark" data-remote="true"><i class="fa-solid fa-arrow-left"></i></a>
                            </li>
                        <?php
                            }
                        ?>
                        ...
                        ?>
                            <li class="page-item active" >
                                <span rel="prev" class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark" style="background-color:#C7C8C9; border:0;" data-remote="true"><?php echo $i ?></span>
                            </li>
                        <?php
                                }  else {
                        ?>
                        ...
                        ?>
                            <li class="page-item">
                                <a href="<?php echo $rootPath;?>/product.php?categoryId=<?php echo $categoryId ?>&page=<?php echo ($currentPage + 1) ?>" class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark" data-remote="true"><i class="fa-solid fa-arrow-right"></i></a>
                            </li>
                        <?php
                            }
                        ?>
